...
pub(crate) fn apply_newline_style(newline_style: NewlineStyle, formatted_text: &mut String, raw_input_text: &str) {
...
fn effective_newline_style(newline_style: NewlineStyle, raw_input_text: &str) -> EffectiveNewlineStyle {
    match newline_style {
...
mod tests {
    ...
    fn falls_back_to_native_newlines_if_no_newlines_are_found() {
        ...
        assert_eq!(expected_newline_style, auto_detect_newline_style("One Two Three"));
    }
    ...
    fn auto_detects_and_applies_native_newlines() {
        ...
        if cfg!(windows) {
            assert_eq!("One\r\nTwo\r\nThree", &out, "auto-native-windows should detect 'crlf'");
        } else {
            assert_eq!("One\nTwo\nThree", &out, "auto-native-unix should detect 'lf'");
        }
    }
